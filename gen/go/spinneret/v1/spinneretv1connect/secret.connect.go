...
const (
	...
	SecretServiceName = "spinneret.v1.SecretService"
)
...
const (
	...
	SecretServiceGetSecretProcedure = "/spinneret.v1.SecretService/GetSecret"
)

// SecretServiceClient is a client for the spinneret.v1.SecretService service.
...
// NewSecretServiceClient constructs a client for the spinneret.v1.SecretService service. By
...
func NewSecretServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) SecretServiceClient {
	...
	secretServiceMethods := v1.File_spinneret_v1_secret_proto.Services().ByName("SecretService").Methods()
...
// GetSecret calls spinneret.v1.SecretService.GetSecret.
...
// SecretServiceHandler is an implementation of the spinneret.v1.SecretService service.
...
func NewSecretServiceHandler(svc SecretServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/spinneret.v1.SecretService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedSecretServiceHandler) GetSecret(context.Context, *connect.Request[v1.GetSecretRequest]) (*connect.Response[v1.GetSecretResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("spinneret.v1.SecretService.GetSecret is not implemented"))
}
